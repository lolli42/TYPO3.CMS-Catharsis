...
$GLOBALS['TCA']['sys_workspace'] = require_once($extensionTcaPath . 'sys_workspace.php');
$GLOBALS['TCA']['sys_workspace_stage'] = require_once($extensionTcaPath . 'sys_workspace_stage.php');
